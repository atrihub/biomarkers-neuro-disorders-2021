...
ggplot(subset(dd, DX!='MCI'), aes(x=ABETA, y=TAU)) + 
  ...
  geom_line(data=data.frame(ABETA=80:1700, TAU=3*(80:1700)), aes(color=TAU/ABETA)) +
  geom_line(data=data.frame(ABETA=80:1700, TAU=1/3*(80:1700)), aes(color=TAU/ABETA)) +
  geom_line(data=data.frame(ABETA=80:1700, TAU=4*(80:1700)), aes(color=TAU/ABETA)) +
...
line now is where ratio = 1 (intercept = 0; slope =1, y=x; y/x=1)
