...
```{r, fig.height=4.5, fig.width=4.5*2}
par(mfrow=c(1,2))
...
```{r, fig.height=2.25, fig.width=3*(2)}
...
htmlwidgets::saveWidget(fig, paste0("3dfig.html"))
```

<iframe src="3dfig.html" width="100%" height="500" id="igraph" scrolling="no" seamless="seamless" frameBorder="0"> </iframe>
